const createNavigate = (context)=>({ messageName, url, redirect, stateAction })=>async (callback)=>{
            const parsedUrl = new URL(url ?? "", new URL(context?.request?.url ?? window.location.href));
            if (redirect) {
                if (context?.request) {
            ...
            if (url && typeof window != "undefined") {
                if (stateAction == "replace") window.history.replaceState({}, null, parsedUrl.href);
                else {
...
export { createNavigate as createNavigate };
export { dirname2 as dirname, extname2 as extname, join2 as join, relative2 as relative };
